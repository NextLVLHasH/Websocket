...
sidebar_label: Stamina System
sidebar_position: 7
description: Complete documentation of the Hytale stamina system for managing player and entity stamina consumption, regeneration, and combat integration
---

# Stamina System

The Stamina System in Hytale manages stamina consumption and regeneration for entities. Stamina is used for various actions including sprinting, combat interactions, and blocking. The system integrates with the Entity Stats system and provides configurable gameplay mechanics.
...
| Cost Type | Description | Default Value |
|-----------|-------------|---------------|
| `MAX_HEALTH_PERCENTAGE` | Defines how many % of max health equals 1 stamina point | 0.04 (4%) |
| `DAMAGE` | Defines how much damage equals 1 stamina point | N/A |
...
| State | Description |
|-------|-------------|
| `sprinting` | Player is sprinting (high stamina consumption) |
| `running` | Player is running |
| `walking` | Player is walking |
| `jumping` | Player is jumping |
| `rolling` | Player is rolling (can mitigate fall damage) |
...
| `mantling` | Player is mantling over obstacles |
...
| Command | Description |
|---------|-------------|
| `/player stats get <player> Stamina` | Get a player's current stamina |
| `/player stats set <player> Stamina <value>` | Set a player's stamina |
| `/player stats add <player> Stamina <amount>` | Add to a player's stamina |
| `/player stats sub <player> Stamina <amount>` | Subtract from player's stamina |
| `/player stats settomax <player> Stamina` | Set player's stamina to maximum |
| `/player stats reset <player> Stamina` | Reset player's stamina |
