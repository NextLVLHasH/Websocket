...
sidebar_label: Collision System
sidebar_position: 7
description: Complete documentation of the Hytale collision detection system for blocks, entities, raycasting, and physics integration
---
...
|----------|-------|-------------|
| `MATERIAL_EMPTY` | 1 | Empty/air blocks |
| `MATERIAL_FLUID` | 2 | Fluid blocks (water, lava) |
| `MATERIAL_SOLID` | 4 | Solid blocks |
| `MATERIAL_SUBMERGED` | 8 | Submerged in fluid |
| `MATERIAL_DAMAGE` | 16 | Damage-dealing blocks |
