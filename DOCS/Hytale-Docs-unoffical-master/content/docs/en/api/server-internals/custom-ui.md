...
```json
{
  ...
  "Name": "Your Plugin",
  "Version": "1.0.0",
  "EntryPoint": "com.NextLVLHasH.plugin.YourPlugin",
...
Create `src/main/java/com/NextLVLHasH/plugin/ui/MyPage.java`:

```java
package com.NextLVLHasH.plugin.ui;
...
Create `src/main/java/com/NextLVLHasH/plugin/commands/OpenUICommand.java`:

```java
package com.NextLVLHasH.plugin.commands;

import com.NextLVLHasH.plugin.ui.MyPage;
...
```java
package com.NextLVLHasH.plugin;

import com.NextLVLHasH.plugin.commands.OpenUICommand;
